...
import DGECForm from './Form/dgec/DGECForm';
import RegistroCurricularForm from './Form/registrocurricular/RegistroCurricularForm';
import AdmisionForm from './Form/admision/AdmisionForm';
import FinanzasForm from './Form/finanzas/FinanzasForm';
